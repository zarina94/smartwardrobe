...
const items: DrawerItemProps[] = [
  { icon: "zap", label: "Outfit Suggestions", screen: "OutfitIdeas", color: "primary" },
  ...
  { icon: "clock", label: "Weather", screen: "Weather", color: "drawer3" },
      ...
      <Box flex={0.8}>
        ...
        >
          ...
          <Box marginVertical="m">
            <Text variant="title1" textAlign="center">smartwardrobe</Text>
            <Text variant="body" textAlign="center">smartwardrobe@smartwardrobe.com</Text>
          </Box>
